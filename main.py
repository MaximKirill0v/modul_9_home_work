...
# А где класс RentCarService? И зачем нужен class BookCarByNumber?
# Подумайте как реализовать бронирование автомобиля в классе RentCarService.
# Заменил класс BookCarByNumber на класс RentCarService
